...
sbatch --job-name=dr5_py_min_b512_p260_$RANDOM --export=MIXED_PRECISION_STRING=--mixed-precision,GPUS=1 $TRAIN_JOB

# otherwise full hardware (standard setup) - 2 gpus, mixed precision
sbatch --job-name=dr5_py_gr_b512_p260_2pgu_$RANDOM --export=MIXED_PRECISION_STRING=--mixed-precision,GPUS=2 $TRAIN_JOB
