...
def main():
    ...
    model_index = 'm0' # TODO rename current models with m0

    checkpoint = f'all_campaigns_ortho_v2_{model_index}'
    # checkpoint = f'all_campaigns_ortho_v2_but_train_only_dr5_{model_index}'
    # checkpoint = f'all_campaigns_ortho_v2_but_train_only_dr12_dr5_{model_index}'
