...
For example, you can train a classifier to find ring galaxies in around `200 lines of code <https://github.com/mwalmsley/zoobot/blob/main/finetune_minimal.py>`_.
